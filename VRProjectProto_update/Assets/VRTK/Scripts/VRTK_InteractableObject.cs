...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        {
            if (gameObject.tag == "picturePiece")
                gameObject.GetComponent<PieceScript>().PieceFound();
            else
            {
        ...
        protected virtual void InitialiseHighlighter()
        {
            if (highlightOnTouch)
            {
                ...
                if (objectHighlighter == null)
                {
                    ...
                    objectHighlighter = gameObject.AddComponent<VRTK_OutlineObjectCopyHighlighter>();
                }
